...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.Ui_MainWindow.listWidget.hide()
    ...
    def table_widget_init(self):
        ...
        self.Ui_MainWindow.tableWidget.setColumnHidden(0,True)  # 隐藏第0列
        self.Ui_MainWindow.tableWidget.horizontalHeader().setSectionResizeMode(QtWidgets.QHeaderView.Stretch)  # 表宽自动适应
        self.Ui_MainWindow.tableWidget.horizontalHeader().setFont(QtGui.QFont("黑体", 12, QtGui.QFont.Bold)) # 表头字体
        # self.Ui_MainWindow.tableWidget.item(0,0).setBackground(QtGui.QColor(250,0,0))
